  ...
  <section class="section-group editor-panel design-panel">
    ...
    <div class="editor-panel__body">
      ...
      <section class="editor-subsection" :class="{ collapsed: sections.backgrounds }">
        <div class="section-head" @click="onSectionHeaderClick('backgrounds', $event)"><button class="caret mini" type="button" @click.stop="toggleSection('backgrounds')"><font-awesome-icon :icon="['fas', 'image']" /></button><h4>Backgrounds</h4></div>
