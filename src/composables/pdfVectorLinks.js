...
export function capturePdfLinks(root) {
  ...
  return {
    ...
    fontStyleUrls: Array.from(root.ownerDocument?.querySelectorAll('link[id^="gf-"]') || [], (link) => link.href),
    ...
    links: Array.from(root.querySelectorAll('a[href]')).flatMap((anchor) => {
...
export function vectorPageLinks(capture, canvas, page) {
