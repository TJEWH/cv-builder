...
import { createSvgDocument, renderVectorPreview } from '../src/composables/pdfVectorPreview.js';

const call = (method, ...args) => ({ type: 'call', method, args });
const text = (value, y) => ({ ...call('fillText', value, 10, y), font: { family: 'Inter', size: 12, weight: 400, style: 'normal' }, metrics: { width: 40, actualBoundingBoxAscent: 10, actualBoundingBoxDescent: 2 } });
