...
const database: Record<string, Row[]> = {
  opportunities: [
    { id: '10000000-0000-4000-8000-000000000001', opportunity_key: 'robotics-phd',
      ...
      data: { work_pattern: 'Hybrid', funding: 'Fully funded' }, created_at: now, updated_at: now },
    { id: '10000000-0000-4000-8000-000000000002', opportunity_key: 'research-engineer',
      ...
      availability: 'open', created_at: now, updated_at: now },
...
const Fixture = defineComponent({
  setup() {
    ...
    return () => h('main', { style: 'padding:16px;max-width:1440px;margin:auto' }, [
