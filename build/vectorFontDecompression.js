...
export function makeWoff2DecoderModule(source) {
...
export function makeFontkitVariableSubsetsCompatible(source) {
...
export default function vectorFontDecompression() {
  return {
    ...
    resolveId(id, importer) {
      ...
      if (id === 'fontkit' && importer?.split('?')[0].endsWith('/src/composables/pdfVectorExport.js')) return fontkitId;
    },
    load(id) {
      if (id === decoderId) {
